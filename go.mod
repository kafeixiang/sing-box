...
replace github.com/sagernet/quic-go => github.com/sagernet/quic-go v0.59.0-sing-box-mod.4

replace github.com/sagernet/sing-tun => github.com/sagernet/sing-tun v0.8.10
